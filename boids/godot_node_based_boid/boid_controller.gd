...
@export_range(0, 200) var num_boids: int = 20;
@export_range(0, 10.0) var boid_speed: float = 5.0;
@export_range(0, 10.0, 0.1) var separation: float = 1.0;
@export_range(0, 2.0) var alignment: float = 1.0;
@export_range(0, 0.001, 0.000001) var cohesion: float = 1.0;
@export_range(10, 200) var sight_radius: float = 100;
@export_range(5, 180) var sight_fov_degrees: float = 180;
